...
public class CardTypeSpinAdapter extends ArrayAdapter<CardType> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private ArrayList<CardType> values;

    public CardTypeSpinAdapter(Context context, int textViewResourceId,
                                 ArrayList<CardType> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getmType());
